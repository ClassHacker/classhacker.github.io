                ...
                <AnimationOnScroll animateIn='animate__fadeIn' animateOut='animate__fadeOut'>
                  <div className='flag-wrapper'>
                    ...
                    <span className='time-wrapper' data-aos="zoom-in-left">
                      <span className='time neumorphism-card'>July 2025 - Present</span>
                    </span>
                  </div>
                    ...
                    <div className="desc neumorphism-card" data-aos="zoom-in-left">
                      Framework & Languages Used
                        <div className="tag-wrapper">
                            ...
                            <span className="tag neumorphism-card">Spring Framework</span>
                            <span className="tag neumorphism-card">Spring Boot</span>
                            <span className="tag neumorphism-card">Camunda Platform</span>
                    ...
                    <div className="desc neumorphism-card" data-aos="zoom-in-left">
                      IDEs & Tools Used
                        <div className="tag-wrapper">
                            ...
                            <span className="tag neumorphism-card">GitLab</span>
                            <span className="tag neumorphism-card">GitHub Copilot</span>
              ...
              <div className='direction-r'>
                <AnimationOnScroll animateIn='animate__fadeIn' animateOut='animate__fadeOut'>
                  <div className='flag-wrapper'>
                    ...
                    <span className='time-wrapper' data-aos="zoom-in-left">
                      <span className='time neumorphism-card'>Aug 2021 - July 2025</span>
                    </span>
                  </div>
                  <div className='neumorphism-card-mid'>
                    System Engineer
